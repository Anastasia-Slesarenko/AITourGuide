...
class AsyncWikidataCollector:
    ...
    def __init__(self, user_agent: str = None, delay: float = 1.0, debug: bool = False):
    ...
    async def _retry_request(self, url: str, method: str = "GET", 
                            params: dict = None, data: bytes = None, 
                            headers: dict = None, max_retries: int = 3) -> Optional[aiohttp.ClientResponse]:
